...
import img from "../public/assets/illustration.png";
      ...
      <section className="flex w-full">
        ...
        <main className="container py-12 mx-10 md:mx-14">
          ...
          <div className="table-div-custom block mb-4 md:mb-12">
            <form className="w-full pb-4" onSubmit={submitForm}>
              {/* top */}
              <div>
                <div className="">
                ...
                {/* <div className="flex md:px-6 flex-col md:flex-row text-sm font-bold md:font-medium md:text-base text-gray-700"> */}
                <div className="m-auto bg-slate-50 rounded-md w-3/5 grid lg:grid-cols-2 drop-shadow-md border">
                  {/* image */}
                  {/* <div className="py-20 mr-32">
                    <Image
                      src={img}
                  ...
                  {/* form */}
                  <div className="py-8 px-12 bg-[#fff]">
                    {/* top left */}
                    <div>
                    ...
                    <div className="text-center mt-8">
                      ...
                      <button
                        type="submit"
                        className="group text-sm font-bold gap-2 py-2 px-8 md:px-4 bg-[#00326A] text-white hover:opacity-80 transition duration-700 rounded-md"
                      >
                        Submit
                      </button>
                    </div>
