          ...
          >
            ...
            <div className="flex flex-col lg:grid lg:grid-cols-12 lg:gap-10 pb-0 md:pb-2 pt-3">
              ...
              <div className="text-primary lg:col-span-4 flex justify-center items-center mb-0">
                <div className="border-y-8 border-y-primary rounded-full w-fit p-6">
              ...
              <div className="flex flex-col justify-center md:mt-[40px] lg:mt-[-40px] lg:col-span-8">
                <div>
                  ...
                  {/* 2 */}
                  <div className="details my-8 flex items-center gap-4">
                    <h5>
                      <b>
                        {theme.language === "Bahasa" ? "Bahasa:" : "Language:"}
                      </b>
                      <br />
                      <label className="inline-flex relative items-center cursor-pointer mt-2">
                        <button
                          ...
                          disabled={
                            theme.language === "Bahasa" ? "disabled" : ""
                          }
                        ...
                        <button
                          ...
                          disabled={
                            theme.language === "English" ? "disabled" : ""
                          }
