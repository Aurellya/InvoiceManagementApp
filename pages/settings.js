    ...
    <>
      ...
      <section className="flex">
        ...
        <main className="container py-12 mx-14">
          ...
          {/* 1 */}
          <div className="details mt-10 flex items-center gap-4">
            <h5>
              <b>
                {theme.language === "Bahasa" ? "Tukar Mode: " : "Switch Mode: "}
              </b>
            </h5>
          ...
          {/* 2 */}
          <div className="details my-2 flex items-center gap-4">
            <h5>
          ...
          <div className="my-8">
            <button className="group flex items-center text-sm font-bold gap-2 py-2 px-4 bg-[#F44645] text-white hover:opacity-80 transition duration-700 rounded-md">
              ...
              <h2 className="whitespace-pre">
                {theme.language === "Bahasa" ? "Hapus Akun" : "Delete Account"}
              </h2>
            </button>
          </div>
        </main>
