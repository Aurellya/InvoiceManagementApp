            ...
            <div className="m-auto bg-slate-50 rounded-t-md w-full grid lg:grid-cols-12 drop-shadow-md border border-t-8 border-t-[#0E3658]">
              ...
              >
                <div className="text-white">
                  <div className="title text-center mb-10 border-2 border-white">
                    {/* <div className="title text-center mb-6 bg-[#0E3658]"> */}
                    {/* <h1 className="text-gray-800 text-3xl md:text-4xl font-bold py-4"> */}
                    <h1 className="text-white text-3xl md:text-4xl font-bold py-4">
                      Details
                    </h1>
                  </div>
                  ...
                  <div className="form-group mb-6">
                    ...
                    <input
                      type="text"
                      className="form-control block px-3 py-1.5 w-full font-normal text-gray-300 bg-white bg-clip-padding border border-solid border-gray-300 rounded m-0"
                      name="date"
                      id="date"
              ...
              {/* right */}
              <div
                className={`lg:col-span-9 lg:block w-full lg:h-[712px] lg:overflow-auto`}
              >
