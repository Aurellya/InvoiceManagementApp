...
function User({ session, handleSignOut }) {
  ...
  const getInvoices = async () => {
    ...
    const invoices = invoicesObj.data.slice(0, 6);
    ...
    <>
      ...
      <section className="flex">
        ...
        <main className="container py-12 mx-10 md:mx-14">
          ...
          {!loading && summary && invoices && monthlyRevenue && (
            <>
              {/* summary dashboard */}
              <div
                ...
                >
                  ...
                  <div>
                            ...
                            <tr className="bg-white" key={invoice._id}>
                              <td className="p-3 text-sm text-primary font-bold whitespace-nowrap">
                                <Link
                                  ...
                                  className="transition duration-700 hover:underline hidden lg:block"
                                >
                              ...
                              <td className="p-3 text-sm text-gray-700 whitespace-nowrap  hidden lg:block">
                                {invoice.customer_name.length > 24
                                  ? invoice.customer_name.slice(0, 24) + " ..."
                                  : invoice.customer_name}{" "}
                              </td>
                              <td className="p-3 text-sm text-gray-700 whitespace-nowrap md:block lg:hidden">
                    ...
                    <div className="mt-6 text-center">
                      <Link
                        className="w-fit text-primary hover:underline hover:opacity-80"
                        href="/invoices"
                      >
                      ...
                      {monthlyRevenue.map((mr) => (
                        ...
                        >
                          <div className="flex border rounded shadow p-2 overflow-hidden py-3">
                            <div className="bg-primary w-[18px] rounded md:hidden"></div>
                            <div className="flex-1 text-right">
